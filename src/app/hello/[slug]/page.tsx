  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-blue-400 font-semibold text-sm uppercase tracking-wide mb-3">
                Keynote Speaker · AI Strategist
              </p>
              ...
              {p.valueProps.map((vp, i) => (
                <div key={i} className="mb-6">
                  <h2 className="text-xl font-semibold text-blue-300 mb-1">{vp.headline}</h2>
                  <p className="text-gray-300">{vp.subtext}</p>
                </div>
              ))}
              <a
                href={p.ctaUrl}
                className="inline-block bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 transition mt-4"
              >
                {p.ctaText}
              </a>
            </div>
            <div className="flex justify-center">
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10">
      ...
      <section className="bg-blue-600 py-6">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-4 text-center text-white">
            <div>
              <div className="text-2xl md:text-3xl font-bold">TEDx</div>
              <div className="text-sm text-blue-100">Speaker</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold">10-40 hrs</div>
              <div className="text-sm text-blue-100">Reclaimed Weekly</div>
            </div>
            <div>
              <div className="text-2xl md:text-3xl font-bold">4 Levels</div>
              <div className="text-sm text-blue-100">AI Ascension Model</div>
            </div>
          </div>
        </div>
      </section>

      {/* ── Personalized video (or placeholder) ── */}
          ...
          {p.videoUrl ? (
            ...
            <div className="aspect-video rounded-xl bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-lg">Personalized video for {p.org} coming soon</p>
              </div>
            </div>
          )}
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-blue-600 font-semibold text-sm uppercase tracking-wide mb-3 text-center">About Dan</p>
          ...
          <div className="max-w-3xl mx-auto text-gray-600 leading-relaxed space-y-4">
            <p>
              ...
              a company built on one belief: <strong>AI should protect your humanity, not consume it.</strong>
            </p>
            <p>
              His signature keynote, <em>Humanity Amplified</em>, reframes the entire AI conversation.
              While most speakers promise faster output and more automation, Dan asks the uncomfortable
              question: &ldquo;AI can save you 10 hours a week — but do you know what you&apos;d do with them?&rdquo;
            </p>
            <p>
              Dan&apos;s framework is built on a simple distinction: <strong>Machine Work vs. Meaning Work.</strong>{" "}
              Machine Work — research, formatting, repetitive emails, meeting summaries — is what AI should handle.
              Meaning Work — coaching, vision-casting, mentoring, being present — is what humans must fiercely protect.
            </p>
            <p>
              His <strong>AI Ascension model</strong> (Explorer → Assistant → Agent → Commander) gives leaders
              a practical roadmap from AI curiosity to reclaiming 30+ hours per week.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-blue-600 font-semibold text-sm uppercase tracking-wide mb-3 text-center">Keynote Topics</p>
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">
            Transformational Talks That Move People to Action
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-blue-600 mb-2">Signature Keynote · 45-60 min</p>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Humanity Amplified</h3>
              <p className="text-gray-600 text-sm">
                What should AI do so humans can do what matters most? Dan draws the line between
                Machine Work and Meaning Work, giving audiences a roadmap to reclaim 10-40 hours per week.
              </p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-blue-600 mb-2">Executive Track · 30-45 min</p>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Machine Work vs. Meaning Work</h3>
              <p className="text-gray-600 text-sm">
                A practical framework for leaders to audit their team&apos;s AI adoption. Real examples,
                real ROI, and the insight that the best AI leaders are the best delegators.
              </p>
            </div>
            <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100">
              <p className="text-sm font-semibold text-blue-600 mb-2">Closing Keynote · 30-45 min</p>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Commander Mode</h3>
              <p className="text-gray-600 text-sm">
                Most people don&apos;t fail at AI adoption — they drift through it. This talk introduces
                Commander Mode: intentionally designing an AI-powered life instead of reacting to the hype.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-blue-600 font-semibold mt-8 text-lg">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-blue-600 font-semibold text-sm uppercase tracking-wide mb-3 text-center">
      ...
      {/* ── Final CTA ── */}
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-700 text-center">
      ...
      <section className="py-12 bg-gray-900 text-center">
        <div className="max-w-6xl mx-auto px-4">
          <p className="text-gray-400 mb-4">Follow Dan on Social Media</p>
          <div className="flex justify-center gap-6">
            <a href="https://www.linkedin.com/in/daniel-gentry/" className="text-gray-400 hover:text-white transition" target="_blank" rel="noopener">LinkedIn</a>
            <a href="https://www.youtube.com/channel/UCLoq_zdO_H37-VV2GttNP6g" className="text-gray-400 hover:text-white transition" target="_blank" rel="noopener">YouTube</a>
            <a href="https://www.skool.com/impact-ai" className="text-gray-400 hover:text-white transition" target="_blank" rel="noopener">Community</a>
          </div>
